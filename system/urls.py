...
urlpatterns = [	
	...
	path('atualizar_corretor/<str:id>', views.atualizarCorretor, name="atualizar_corretor"),
	...
	path('atualizar_imovel/<str:id>', views.atualizarImovel, name="atualizar_imovel"),
